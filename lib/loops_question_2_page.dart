...
import 'package:coding_dojo_app/beginner_theory/loops_q_2_theory.dart';
...
class LoopsQuestion2 extends StatefulWidget {
  @override
  _LoopsQuestion2State createState() => _LoopsQuestion2State();
}

class _LoopsQuestion2State extends State<LoopsQuestion2> {
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => LoopsQuestion2Theory()),
                      );
                    },
