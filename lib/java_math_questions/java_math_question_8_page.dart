...
import 'package:coding_dojo_app/beginner_theory/jm_q_8_theory.dart';
...
class JavaMathQuestion8 extends StatefulWidget {
  @override
  _JavaMathQuestion8State createState() => _JavaMathQuestion8State();
}

class _JavaMathQuestion8State extends State<JavaMathQuestion8> {
  ...
  var options = [["lol",0],["Math.sqrt",0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "Given the variable ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'lol', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ', calculate its square-root and store it in '),
                    TextSpan(text: 'sqr', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '.'),
                  ]
              ),
            ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => JavaMathQuestion8Theory()),
                      );
                    },
