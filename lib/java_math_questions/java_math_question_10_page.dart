...
import 'package:coding_dojo_app/beginner_theory/jm_q_10_theory.dart';
...
class JavaMathQuestion10 extends StatefulWidget {
  @override
  _JavaMathQuestion10State createState() => _JavaMathQuestion10State();
}

class _JavaMathQuestion10State extends State<JavaMathQuestion10> {

  var blanks = [[1, 0, -1],[2, 0, -1],[3, 0, -1],[0, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var blanks2 = [[1, 0, -1],[2, 0, -1],[0, 0, -1],[3, 0, -1]];
  // this is the same as blanks but is made if 1 blank could have more than 1 option as its right answer

  var blanks3 = [[2, 0, -1],[1, 0, -1],[0, 0, -1],[3, 0, -1]];
  var blanks4 = [[2, 0, -1],[1, 0, -1],[3, 0, -1],[0, 0, -1]];
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "Find the maximum of ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'a', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and '),
                    TextSpan(text: 'b', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and the maximum of '),
                    TextSpan(text: 'c', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and '),
                    TextSpan(text: 'd', style: TextStyle(color:Colors.pink)),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => JavaMathQuestion10Theory()),
                      );
                    },
