...
import 'package:coding_dojo_app/beginner_theory/jm_q_6_theory.dart';
...
class JavaMathQuestion6 extends StatefulWidget {
  @override
  _JavaMathQuestion6State createState() => _JavaMathQuestion6State();
}

class _JavaMathQuestion6State extends State<JavaMathQuestion6> {

  var blanks = [[4, 0, -1],[3, 0, -1],[0, 0, -1],[1, 0, -1],[2, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["100",0],["*",0],["osp",0],["/",0],["dp",0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "Find the discount on an item if the discount percent is ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'dp', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and the original selling price is '),
                    TextSpan(text: 'osp', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '.'),
                  ]
              ),
            ),
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(text: ' // 50% discount', style: TextStyle(color:Colors.green)),
                        ]
                    ),
                  ),
                  SizedBox(height: 5),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => JavaMathQuestion6Theory()),
                      );
                    },
