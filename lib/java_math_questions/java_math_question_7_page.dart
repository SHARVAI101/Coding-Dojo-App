...
import 'package:coding_dojo_app/beginner_theory/jm_q_7_theory.dart';
...
class JavaMathQuestion7 extends StatefulWidget {
  @override
  _JavaMathQuestion7State createState() => _JavaMathQuestion7State();
}

class _JavaMathQuestion7State extends State<JavaMathQuestion7> {

  var blanks = [[1, 0, -1],[2, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["5/9",0],["c",0],["9/5",0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "You are given the temperature in degree celcius in variable ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'c', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '. Convert this into degree farenheit and store it in '),
                    TextSpan(text: 'f', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '.'),
                  ]
              ),
            ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => JavaMathQuestion7Theory()),
                      );
                    },
