...
class JavaMathQuestion5 extends StatefulWidget {
  @override
  _JavaMathQuestion5State createState() => _JavaMathQuestion5State();
}

class _JavaMathQuestion5State extends State<JavaMathQuestion5> {
  ...
  var options = [["*", 0],["%",0],["/",0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "Find the remainder when variable ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'apple', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' is divided by '),
                    TextSpan(text: 'doctor', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and store it in '),
                    TextSpan(text: 'away', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '.'),
                  ]
              ),
            ),
                  ...
                  Wrap(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(top: 6),
                          child: Text(
                            'System.out.println(" The remainder is = " + away );',
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => JavaMathQuestion5Theory()),
                      );
                    },
