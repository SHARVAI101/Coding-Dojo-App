...
import 'package:coding_dojo_app/beginner_theory/jm_q_2_theory.dart';
...
class JavaMathQuestion2 extends StatefulWidget {
  @override
  _JavaMathQuestion2State createState() => _JavaMathQuestion2State();
}

class _JavaMathQuestion2State extends State<JavaMathQuestion2> {

  var blanks = [[0, 0, -1],[1, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["3.2456f", 0],["3.2456745646",0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Store the values in the correct variables.",
              style: TextStyle(
                fontFamily: 'FreeSans',
                fontSize: 15,
              ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => JavaMathQuestion2Theory()),
                      );
                    },
