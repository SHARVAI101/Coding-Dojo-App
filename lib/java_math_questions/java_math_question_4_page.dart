...
class JavaMathQuestion4 extends StatefulWidget {
  @override
  _JavaMathQuestion4State createState() => _JavaMathQuestion4State();
}

class _JavaMathQuestion4State extends State<JavaMathQuestion4> {

  var blanks = [[1, 0, -1],[0, 0, -1],[2, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["b", 0],["a",0],["*",0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "Given the two integer variables ",
