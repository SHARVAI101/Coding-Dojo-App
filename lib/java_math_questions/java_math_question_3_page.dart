...
class JavaMathQuestion3 extends StatefulWidget {
  @override
  _JavaMathQuestion3State createState() => _JavaMathQuestion3State();
}

class _JavaMathQuestion3State extends State<JavaMathQuestion3> {

  var blanks = [[0, 0, -1],[1, 0, -1],[2, 0, -1],[3, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["y", 0],["/",0],["3",0],["avg",0]]; // 0: Answer text, 1: 1=selected 0=not selected
            ...
            RichText(
              text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(text: ' and '),
                    TextSpan(text: 'z', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and store it in the variable '),
                    TextSpan(text: 'avg', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '.'),
                  ]
              ),
            ),
            Text(
              "Once the calculation is done, print the average.",
              style: TextStyle(
                fontFamily: 'FreeSans',
                fontSize: 15,
              ),
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    SizedBox(height: 10),
                                    Text(
                                      'Notice: We used the data type float because we have decimal numbers and result',
                                      style: TextStyle(
                                        color: Colors.red
                                      ),
                                    )
