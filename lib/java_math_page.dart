...
import 'package:coding_dojo_app/java_math_questions/java_math_question_10_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_1_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_2_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_3_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_4_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_5_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_6_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_7_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_8_page.dart';
import 'package:coding_dojo_app/java_math_questions/java_math_question_9_page.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:shared_preferences/shared_preferences.dart';

class JavaMathPage extends StatefulWidget {
  @override
  _JavaMathPageState createState() => _JavaMathPageState();
}

class _JavaMathPageState extends State<JavaMathPage> {
  ...
  var allquestions = [
    ['Kindergarten Math', JavaMathQuestion1(), 0, 0, "jmq1"],
    ['Float & Double', JavaMathQuestion2(), 2, 0, "jmq2"],
    ['Average', JavaMathQuestion3(), 2, 0, "jmq3"],
    ['Equations - I', JavaMathQuestion4(), 2, 0, "jmq4"],
    ['Modulus', JavaMathQuestion5(), 2, 0, "jmq5"],
    ['Discount', JavaMathQuestion6(), 2, 0, "jmq6"],
    ['Temperatures', JavaMathQuestion7(), 2, 0, "jmq7"],
    ['Square-Root', JavaMathQuestion8(), 2, 0, "jmq8"],
    ['Minimum Number', JavaMathQuestion9(), 2, 0, "jmq9"],
    ['Maximum Number', JavaMathQuestion10(), 2, 0, "jmq10"],
  ];
  ...
  Future<void> setAllQuestions() async{
    ...
    // prefs.remove("completed_jm_questions");
    if(prefs.getString("completed_jm_questions")!=null){
      ...
      var _lastquestionsolvedID=completed_jm_questions[completed_jm_questions.length-1];
