...
import 'package:coding_dojo_app/numbers_questions/numbers_question_1_page.dart';
...
class _NumbersPageState extends State<NumbersPage> {
  ...
  var allquestions = [
    ['Odd or Even', NumbersQuestion1(), 0, 0, "nmbq1"],
  ...
  Future<void> setAllQuestions() async{
    ...
    // prefs.remove("completed_nmb_questions");
    if(prefs.getString("completed_nmb_questions")!=null){
      ...
      var _lastquestionsolvedID=completed_nmb_questions[completed_nmb_questions.length-1];
