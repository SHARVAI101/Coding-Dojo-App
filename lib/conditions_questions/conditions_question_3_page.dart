...
import 'package:coding_dojo_app/beginner_theory/con_q_3_theory.dart';
...
class ConditionsQuestion3 extends StatefulWidget {
  @override
  _ConditionsQuestion3State createState() => _ConditionsQuestion3State();
}

class _ConditionsQuestion3State extends State<ConditionsQuestion3> {

  var blanks = [[2, 0, -1],[1, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [['x =!= y', 0], ["x != y",0], ["x == y", 0], ['x = y', 0]]; // 0: Answer text, 1: 1=selected 0=not selected
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: 'x', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and '),
                    TextSpan(text: 'y', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '.'),
                  ]
              ),
            ),
            RichText(
              text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(text: ' and '),
                    TextSpan(text: 'y', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and find if they\'re equal or if they\'re not equal.'),
                  ]
              ),
            ),
            SizedBox(height: 10),
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                        children: [
                          TextSpan(text: '\t\t\t\tSystem.out.println("They are equal");'),
                          TextSpan(text: '\n}'),
                        ]
                    ),
                  ),
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                        children: [
                          TextSpan(text: '\t\t\t\tSystem.out.println("They are not equal");'),
                          TextSpan(text: '\n}'),
                        ]
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ConditionsQuestion3Theory()),
                      );
                    },
