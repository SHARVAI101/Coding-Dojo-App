...
import 'package:coding_dojo_app/beginner_theory/con_q_2_theory.dart';
...
class ConditionsQuestion2 extends StatefulWidget {
  @override
  _ConditionsQuestion2State createState() => _ConditionsQuestion2State();
}

class _ConditionsQuestion2State extends State<ConditionsQuestion2> {
  ...
  var blanks = [[2, 0, -1],[0, 0, -1],[1, 0, -1],[3, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["a < b",0],["a >= b", 0],['a > b', 0],['a <= b', 0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "Compare the relationship between ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'a', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and '),
                    TextSpan(text: 'b', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: ' and display it accordingly.'),
                  ]
              ),
            ),
            SizedBox(height: 10),
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                          ...
                          style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                          children: [
                            TextSpan(text: '\t\t\t\t// a is greater than b', style: TextStyle(color:Colors.green)),
                            TextSpan(text: '\n}'),
                          ]
                      ),
                    ),
                    ...
                    RichText(
                      text: TextSpan(
                          ...
                          style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                          children: [
                            TextSpan(text: '\t\t\t\t// a is less than b', style: TextStyle(color:Colors.green)),
                            TextSpan(text: '\n}'),
                          ]
                      ),
                    ),
                    ...
                    RichText(
                      text: TextSpan(
                          ...
                          style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                          children: [
                            TextSpan(text: '\t\t\t\t// a is greater than or equal to b', style: TextStyle(color:Colors.green)),
                            TextSpan(text: '\n}'),
                          ]
                      ),
                    ),
                    ...
                    RichText(
                      text: TextSpan(
                          ...
                          style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                          children: [
                            TextSpan(text: '\t\t\t\t// a is less than or equal to b', style: TextStyle(color:Colors.green)),
                            TextSpan(text: '\n}'),
                          ]
                      ),
                    ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ConditionsQuestion2Theory()),
                      );
                    },
