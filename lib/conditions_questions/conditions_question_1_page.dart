...
import 'package:coding_dojo_app/beginner_theory/basic_q_0_point_5_theory.dart';
import 'package:coding_dojo_app/beginner_theory/con_q_1_theory.dart';
...
class ConditionsQuestion1 extends StatefulWidget {
  @override
  _ConditionsQuestion1State createState() => _ConditionsQuestion1State();
}

class _ConditionsQuestion1State extends State<ConditionsQuestion1> {
  ...
  var options = [["// do something", 0],["condition", 0],["else", 0]]; // 0: Answer text, 1: 1=selected 0=not selected
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ConditionsQuestion1Theory()),
                      );
                    },
