...
class BasicQuestion1point51 extends StatefulWidget {
  @override
  _BasicQuestion1point51State createState() => _BasicQuestion1point51State();
}

class _BasicQuestion1point51State extends State<BasicQuestion1point51> {

  var blanks = [[2, 0, -1],[0, 0, -1],[1, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["+",0],["name", 0],['"', 0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                  text: "You have a variable called ",
                  style: TextStyle( fontFamily: 'FreeSans', fontSize: 15, color:Colors.black),
                  children: [
                    TextSpan(text: 'name', style: TextStyle(color:Colors.pink)),
                    TextSpan(text: '. Print its value to the output screen.'),
                  ]
              ),
            ),
            SizedBox(height: 10),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BasicQuestion1point51Theory()),
                      );
                    },
