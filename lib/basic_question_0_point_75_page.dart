...
class BasicQuestion0point75 extends StatefulWidget {
  @override
  _BasicQuestion0point75State createState() => _BasicQuestion0point75State();
}

class _BasicQuestion0point75State extends State<BasicQuestion0point75> {

  var blanks = [[2, 0, -1],[1, 0, -1],[0, 0, -1]];
  // 0: Correct answer index from options,
  // 1: 0=not filled 1=filled,
  // 2: index of what is currently filled in this blank

  var options = [["Bruh", 0],["println", 0],["out", 0],]; // 0: Answer text, 1: 1=selected 0=not selected
