...
class CodingDojoStore extends StatefulWidget {
  @override
  _CodingDojoStoreState createState() => _CodingDojoStoreState();
}

class _CodingDojoStoreState extends State<CodingDojoStore> {
  ...
  void initState() {
    ...
    _subscription = purchaseUpdated.listen((purchaseDetailsList) {
      // print("purchaseDetailsList="+purchaseDetailsList.toString());
    ...
    return Container(
      ...
      child: BackdropFilter(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            centerTitle: true,
            title: const Text('Coding Dojo Store'),
    ...
    if (!_isAvailable) {
      children.addAll([
        ...
        ListTile(
          ...
          subtitle: const Text(
              'Unable to connect to the payments processor. Please check your internet connection or restart the app.'),
        ),
      ]);
    }
  ...
  Card _buildProductList() {
    ...
    return Card(
        ...
        Column(
          children: [
            Column(children: <Widget>[productHeader] + productList),
            SizedBox(height:10)
          ],
        ));
  }
