...
class BasicQuestion0point5 extends StatefulWidget {
  @override
  _BasicQuestion0point5State createState() => _BasicQuestion0point5State();
}

class _BasicQuestion0point5State extends State<BasicQuestion0point5> {
  ...
  var options = [["World", 0],["Hello", 0]]; // 0: Answer text, 1: 1=selected 0=not selected
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 5),
            Text(
              "Write your first program and print the words 'Hello World' using Java.",
              style: TextStyle(
                fontFamily: 'FreeSans',
                fontSize: 15,
              ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BasicQuestion0point5Theory()),
                      );
                    },
